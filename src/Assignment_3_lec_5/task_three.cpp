...
void display(void){
    ...
    // Use homogeneous matrix to scale only X-axis to half
    glMatrixMode(GL_MODELVIEW);
    glLoadIdentity();
    
    // Scale only X-axis to half
    glScalef(-0.5, 1.0, 1.0);  // Half width, full height
    
    // Second rectangle scaled
